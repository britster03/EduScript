...
class Simulator:
    ...
    def pick_up_object(self):
        if self.object_picked:
            print("Robot already has an object.")
            return
    ...
    def detect_obstacle(self):
        # Check if any obstacle is within collision range
        for obstacle in self.obstacles:
            distance = self.calculate_distance(self.robot_pos, obstacle['pos'])
